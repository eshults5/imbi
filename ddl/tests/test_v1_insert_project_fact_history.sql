...
INSERT INTO v1.projects (namespace, name, created_by, slug, project_type) VALUES ('test_namespace', 'test_project_2', 'test_user', 'test_slug', 'test_project_type');
...
UPDATE v1.project_facts 
   SET value = 'test_value_2', last_modified_by = 'test_user', "name" = 'test_project_2'
 WHERE value = 'test_value';

 SELECT results_eq(
  $$SELECT value FROM v1.project_fact_history WHERE "name"='test_project_2'$$,
  $$VALUES ('test_value_2')$$,
  'Record exists in v1.project_fact_history after update.');
